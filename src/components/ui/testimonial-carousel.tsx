      ...
      <div className="border border-white/10 bg-white/5 backdrop-blur-md rounded-none w-full relative overflow-hidden">
        ...
        >
          {testimonials.map((testimonial, index) => (
            <article
              key={testimonial.id}
              className="min-w-full h-full flex flex-col items-center justify-between text-center p-6 sm:p-10 md:p-12"
              role="article"
